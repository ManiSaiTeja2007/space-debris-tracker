...
pub fn accel_j3(r: &Vector3<f64>) -> Vector3<f64> {
    ...
    let az = -0.5 * J3_EARTH * (MU_EARTH * R_EARTH.powi(3) / r_norm.powi(5)) * (15.0 * z_r_2 - 35.0 * z_r_2 * z_r_2 + 3.0);
...
pub fn accel_j4(r: &Vector3<f64>) -> Vector3<f64> {
    ...
    let ax = factor * x * (35.0 * z_r_4 - 30.0 * z_r_2 + 3.0);
    let ay = factor * y * (35.0 * z_r_4 - 30.0 * z_r_2 + 3.0);
    let az = factor * z * (35.0 * z_r_4 - 70.0 * z_r_2 + 15.0);
